...
class VodsServer : public common::libev::http::HttpServer {
 public:
  typedef common::libev::http::HttpServer base_class;
  explicit VodsServer(const common::net::HostAndPort& host, common::libev::IoLoopObserver* observer = nullptr);
